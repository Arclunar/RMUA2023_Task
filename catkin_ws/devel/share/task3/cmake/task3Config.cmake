...
if("TRUE" STREQUAL "TRUE")
  set(task3_SOURCE_PREFIX /home/lab/rmua/catkin_ws/src/task3)
  set(task3_DEVEL_PREFIX /home/lab/rmua/catkin_ws/devel)
  set(task3_INSTALL_PREFIX "")
  set(task3_PREFIX ${task3_DEVEL_PREFIX})
else()
  set(task3_SOURCE_PREFIX "")
  set(task3_DEVEL_PREFIX "")
  set(task3_INSTALL_PREFIX /home/lab/rmua/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'task3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lab/rmua/catkin_ws/src/task3/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lab/rmua/catkin_ws/devel/lib;/home/lab/catkin_ws/devel/lib;/opt/ros/noetic/lib)
